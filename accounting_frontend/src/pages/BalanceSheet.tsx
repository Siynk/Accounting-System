...
const BalanceSheet = () => {
    ...
    const handlePrint = () => {
      ...
      if (printWindow) {
        ...
        printWindow.document.write('<p><strong>Company Name:</strong> Joriels Enterprise</p>');
        ...
        printWindow.document.write('<div class="balanceSheet-section-title">Assets');
        printWindow.document.write('<div style="text-align: right; flex-grow: 1; font-weight: normal;">AMOUNT</div>');
        printWindow.document.write('<div style="text-align: right; width: 80px; font-weight: normal;">DATE</div>');
        printWindow.document.write('</div>'); // Close section title
        ...
        // Liabilities Section
        printWindow.document.write('<div class="balanceSheet-section">');
        printWindow.document.write('<div class="balanceSheet-section-title">Liabilities');
        printWindow.document.write('<div style="text-align: right; flex-grow: 1; font-weight: normal;">AMOUNT</div>');
        printWindow.document.write('<div style="text-align: right; width: 80px; font-weight: normal;">DATE</div>');
        printWindow.document.write('</div>'); // Close section title
